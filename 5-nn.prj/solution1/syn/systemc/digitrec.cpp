...
digitrec::digitrec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_update_knn_fu_161->train_inst_V(training_instance_V_reg_332);
    ...
    SC_METHOD(thread_i4_cast3_fu_231_p1);
    sensitive << ( i4_reg_122 );
    ...
    SC_METHOD(thread_j_2_fu_253_p2);
    sensitive << ( j_reg_133 );

    SC_METHOD(thread_k_1_fu_211_p2);
    sensitive << ( k_reg_111 );
    ...
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( tmp_9_cast_fu_226_p1 );
    ...
    SC_METHOD(thread_p_shl_cast_fu_195_p1);
    sensitive << ( tmp_7_fu_187_p3 );

    SC_METHOD(thread_tmp_5_fu_265_p2);
    sensitive << ( i4_cast3_reg_301 );
    sensitive << ( phi_mul_reg_145 );
    ...
    sensitive << ( tmp_cast_fu_183_p1 );
    sensitive << ( p_shl_cast_fu_195_p1 );

    SC_METHOD(thread_tmp_9_cast_fu_226_p1);
    sensitive << ( tmp_9_fu_221_p2 );

    SC_METHOD(thread_tmp_9_fu_221_p2);
    sensitive << ( tmp_8_reg_288 );
    sensitive << ( tmp_cast_6_fu_217_p1 );

    SC_METHOD(thread_tmp_cast_6_fu_217_p1);
    sensitive << ( k_reg_111 );

    SC_METHOD(thread_tmp_cast_fu_183_p1);
    sensitive << ( i_reg_100 );
    ...
    sc_trace(mVcdFile, tmp_8_reg_288, "tmp_8_reg_288");
    sc_trace(mVcdFile, exitcond1_fu_171_p2, "exitcond1_fu_171_p2");
    sc_trace(mVcdFile, k_1_fu_211_p2, "k_1_fu_211_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, i4_cast3_fu_231_p1, "i4_cast3_fu_231_p1");
    sc_trace(mVcdFile, i4_cast3_reg_301, "i4_cast3_reg_301");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, i_3_fu_241_p2, "i_3_fu_241_p2");
    sc_trace(mVcdFile, i_3_reg_309, "i_3_reg_309");
    sc_trace(mVcdFile, j_2_fu_253_p2, "j_2_fu_253_p2");
    sc_trace(mVcdFile, j_2_reg_317, "j_2_reg_317");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, next_mul_fu_259_p2, "next_mul_fu_259_p2");
    sc_trace(mVcdFile, next_mul_reg_322, "next_mul_reg_322");
    sc_trace(mVcdFile, exitcond_fu_247_p2, "exitcond_fu_247_p2");
    sc_trace(mVcdFile, training_instance_V_reg_332, "training_instance_V_reg_332");
    ...
    sc_trace(mVcdFile, tmp_9_cast_fu_226_p1, "tmp_9_cast_fu_226_p1");
    sc_trace(mVcdFile, tmp_6_fu_270_p1, "tmp_6_fu_270_p1");
    sc_trace(mVcdFile, tmp_7_fu_187_p3, "tmp_7_fu_187_p3");
    sc_trace(mVcdFile, tmp_cast_fu_183_p1, "tmp_cast_fu_183_p1");
    sc_trace(mVcdFile, p_shl_cast_fu_195_p1, "p_shl_cast_fu_195_p1");
    sc_trace(mVcdFile, tmp_cast_6_fu_217_p1, "tmp_cast_6_fu_217_p1");
    sc_trace(mVcdFile, tmp_9_fu_221_p2, "tmp_9_fu_221_p2");
...
void digitrec::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
             esl_seteq<1,1,1>(ap_const_lv1_1, exitcond2_fu_235_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
        ...
        i4_reg_122 = ap_const_lv11_0;
                ...
                esl_seteq<1,1,1>(exitcond_fu_247_p2.read(), ap_const_lv1_1))) {
        i4_reg_122 = i_3_reg_309.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(exitcond3_fu_205_p2.read(), ap_const_lv1_1))) {
        i_reg_100 = i_2_reg_283.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
        ...
        k_reg_111 = k_1_fu_211_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read()) && 
         esl_seteq<1,1,1>(grp_update_knn_fu_161_ap_done.read(), ap_const_logic_1))) {
        phi_mul_reg_145 = next_mul_reg_322.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_235_p2.read()))) {
        phi_mul_reg_145 = ap_const_lv15_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i4_cast3_reg_301 = i4_cast3_fu_231_p1.read();
        i_3_reg_309 = i_3_fu_241_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_2_reg_283 = i_2_fu_177_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        j_2_reg_317 = j_2_fu_253_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_247_p2.read()))) {
        next_mul_reg_322 = next_mul_fu_259_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond1_fu_171_p2.read(), ap_const_lv1_0))) {
        tmp_8_reg_288 = tmp_8_fu_199_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        training_instance_V_reg_332 = training_data_V_q0.read();
    }
}
...
void digitrec::thread_exitcond2_fu_235_p2() {
    exitcond2_fu_235_p2 = (!i4_reg_122.read().is_01() || !ap_const_lv11_708.is_01())? sc_lv<1>(): sc_lv<1>(i4_reg_122.read() == ap_const_lv11_708);
}

void digitrec::thread_exitcond3_fu_205_p2() {
    exitcond3_fu_205_p2 = (!k_reg_111.read().is_01() || !ap_const_lv3_5.is_01())? sc_lv<1>(): sc_lv<1>(k_reg_111.read() == ap_const_lv3_5);
}

void digitrec::thread_exitcond_fu_247_p2() {
    exitcond_fu_247_p2 = (!j_reg_133.read().is_01() || !ap_const_lv4_A.is_01())? sc_lv<1>(): sc_lv<1>(j_reg_133.read() == ap_const_lv4_A);
}
...
void digitrec::thread_i4_cast3_fu_231_p1() {
    i4_cast3_fu_231_p1 = esl_zext<15,11>(i4_reg_122.read());
}

void digitrec::thread_i_2_fu_177_p2() {
    i_2_fu_177_p2 = (!i_reg_100.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(i_reg_100.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void digitrec::thread_i_3_fu_241_p2() {
    i_3_fu_241_p2 = (!i4_reg_122.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i4_reg_122.read()) + sc_biguint<11>(ap_const_lv11_1));
}

void digitrec::thread_j_2_fu_253_p2() {
    j_2_fu_253_p2 = (!j_reg_133.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(j_reg_133.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void digitrec::thread_k_1_fu_211_p2() {
    k_1_fu_211_p2 = (!k_reg_111.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(k_reg_111.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void digitrec::thread_knn_set_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        knn_set_V_address0 =  (sc_lv<6>) (tmp_9_cast_fu_226_p1.read());
...
void digitrec::thread_next_mul_fu_259_p2() {
    next_mul_fu_259_p2 = (!phi_mul_reg_145.read().is_01() || !ap_const_lv15_708.is_01())? sc_lv<15>(): (sc_biguint<15>(phi_mul_reg_145.read()) + sc_biguint<15>(ap_const_lv15_708));
}

void digitrec::thread_p_shl_cast_fu_195_p1() {
    p_shl_cast_fu_195_p1 = esl_zext<7,6>(tmp_7_fu_187_p3.read());
}

void digitrec::thread_tmp_5_fu_265_p2() {
    tmp_5_fu_265_p2 = (!i4_cast3_reg_301.read().is_01() || !phi_mul_reg_145.read().is_01())? sc_lv<15>(): (sc_biguint<15>(i4_cast3_reg_301.read()) + sc_biguint<15>(phi_mul_reg_145.read()));
}

void digitrec::thread_tmp_6_fu_270_p1() {
    tmp_6_fu_270_p1 = esl_zext<64,15>(tmp_5_fu_265_p2.read());
}

void digitrec::thread_tmp_7_fu_187_p3() {
    tmp_7_fu_187_p3 = esl_concat<4,2>(i_reg_100.read(), ap_const_lv2_0);
}

void digitrec::thread_tmp_8_fu_199_p2() {
    tmp_8_fu_199_p2 = (!tmp_cast_fu_183_p1.read().is_01() || !p_shl_cast_fu_195_p1.read().is_01())? sc_lv<7>(): (sc_biguint<7>(tmp_cast_fu_183_p1.read()) + sc_biguint<7>(p_shl_cast_fu_195_p1.read()));
}

void digitrec::thread_tmp_9_cast_fu_226_p1() {
    tmp_9_cast_fu_226_p1 = esl_zext<64,7>(tmp_9_fu_221_p2.read());
}

void digitrec::thread_tmp_9_fu_221_p2() {
    tmp_9_fu_221_p2 = (!tmp_8_reg_288.read().is_01() || !tmp_cast_6_fu_217_p1.read().is_01())? sc_lv<7>(): (sc_biguint<7>(tmp_8_reg_288.read()) + sc_biguint<7>(tmp_cast_6_fu_217_p1.read()));
}

void digitrec::thread_tmp_cast_6_fu_217_p1() {
    tmp_cast_6_fu_217_p1 = esl_zext<7,3>(k_reg_111.read());
}

void digitrec::thread_tmp_cast_fu_183_p1() {
    tmp_cast_fu_183_p1 = esl_zext<7,4>(i_reg_100.read());
}

void digitrec::thread_training_data_V_address0() {
    training_data_V_address0 =  (sc_lv<15>) (tmp_6_fu_270_p1.read());
}
...
void digitrec::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(exitcond3_fu_205_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
            }
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_235_p2.read()))) {
            ...
            break;
        case 16 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(exitcond_fu_247_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state4;
            } else {
