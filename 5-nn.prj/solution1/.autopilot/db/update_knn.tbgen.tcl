...
set C_modelArgList {
	...
	{ min_distances_V int 6 regular {array 50 { 2 0 } 1 1 }  }
...
set portList { 
	...
	{ min_distances_V_address1 sc_out sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "min_distances_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "min_distances_V", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	min_distances_V { ap_memory {  { min_distances_V_address0 mem_address 1 6 }  { min_distances_V_ce0 mem_ce 1 1 }  { min_distances_V_we0 mem_we 1 1 }  { min_distances_V_d0 mem_din 1 6 }  { min_distances_V_q0 mem_dout 0 6 }  { min_distances_V_address1 mem_address 1 6 }  { min_distances_V_ce1 mem_ce 1 1 }  { min_distances_V_we1 mem_we 1 1 }  { min_distances_V_d1 mem_din 1 6 } } }
