...
architecture behav of digitrec is 
    ...
    "digitrec,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.310750,HLS_SYN_LAT=993704,HLS_SYN_TPT=none,HLS_SYN_MEM=97,HLS_SYN_DSP=0,HLS_SYN_FF=322,HLS_SYN_LUT=763}";
    ...
    signal tmp_7_cast_reg_278 : STD_LOGIC_VECTOR (5 downto 0);
    signal exitcond1_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_1_fu_201_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal i4_cast3_fu_221_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal i4_cast3_reg_291 : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal i_2_fu_231_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_2_reg_299 : STD_LOGIC_VECTOR (10 downto 0);
    signal j_2_fu_243_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_2_reg_307 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal next_mul_fu_249_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal next_mul_reg_312 : STD_LOGIC_VECTOR (14 downto 0);
    signal exitcond_fu_237_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal training_instance_V_reg_322 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal grp_knn_vote_fu_156_knn_set_V_address0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal grp_update_knn_fu_161_min_distances_V_address0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal grp_update_knn_fu_161_min_distances_V_address1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal exitcond3_fu_195_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_reg_111 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_fu_183_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_cast_fu_207_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_8_fu_211_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_5_fu_255_p2 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    port map (
        ...
        test_inst_V => input_V,
        train_inst_V => training_instance_V_reg_322,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (exitcond2_fu_225_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_fu_237_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                i4_reg_122 <= i_2_reg_299;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond3_fu_195_p2 = ap_const_lv1_1))) then 
                i_reg_100 <= i_1_reg_273;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state7) and (grp_update_knn_fu_161_ap_done = ap_const_logic_1))) then 
                j_reg_133 <= j_2_reg_307;
            elsif (((exitcond2_fu_225_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond3_fu_195_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                k_reg_111 <= k_1_fu_201_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state7) and (grp_update_knn_fu_161_ap_done = ap_const_logic_1))) then 
                phi_mul_reg_145 <= next_mul_reg_312;
            elsif (((exitcond2_fu_225_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                    i4_cast3_reg_291(10 downto 0) <= i4_cast3_fu_221_p1(10 downto 0);
                i_2_reg_299 <= i_2_fu_231_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_237_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                next_mul_reg_312 <= next_mul_fu_249_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_171_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    tmp_7_cast_reg_278(4 downto 1) <= tmp_7_cast_fu_191_p1(4 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                training_instance_V_reg_322 <= training_data_V_q0;
            end if;
        end if;
    end process;
    tmp_7_cast_reg_278(0) <= '0';
    tmp_7_cast_reg_278(5) <= '0';
    i4_cast3_reg_291(14 downto 11) <= "0000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, exitcond1_fu_171_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, exitcond_fu_237_p2, grp_knn_vote_fu_156_ap_done, grp_update_knn_fu_161_ap_done, exitcond3_fu_195_p2, exitcond2_fu_225_p2, ap_CS_fsm_state7, ap_CS_fsm_state8)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((exitcond2_fu_225_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    exitcond2_fu_225_p2 <= "1" when (i4_reg_122 = ap_const_lv11_708) else "0";
    exitcond3_fu_195_p2 <= "1" when (k_reg_111 = ap_const_lv2_2) else "0";
    exitcond_fu_237_p2 <= "1" when (j_reg_133 = ap_const_lv4_A) else "0";
    ...
    i4_cast3_fu_221_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i4_reg_122),15));
    i_1_fu_177_p2 <= std_logic_vector(unsigned(i_reg_100) + unsigned(ap_const_lv4_1));
    i_2_fu_231_p2 <= std_logic_vector(unsigned(i4_reg_122) + unsigned(ap_const_lv11_1));
    j_2_fu_243_p2 <= std_logic_vector(unsigned(j_reg_133) + unsigned(ap_const_lv4_1));
    k_1_fu_201_p2 <= std_logic_vector(unsigned(k_reg_111) + unsigned(ap_const_lv2_1));

    knn_set_V_address0_assign_proc : process(ap_CS_fsm_state3, grp_knn_vote_fu_156_knn_set_V_address0, grp_update_knn_fu_161_min_distances_V_address0, ap_CS_fsm_state7, ap_CS_fsm_state8, tmp_8_cast_fu_216_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            knn_set_V_address0 <= tmp_8_cast_fu_216_p1(5 - 1 downto 0);
    ...
    knn_set_V_we0_assign_proc : process(ap_CS_fsm_state3, grp_update_knn_fu_161_min_distances_V_we0, exitcond3_fu_195_p2, ap_CS_fsm_state7)
    begin
        if (((exitcond3_fu_195_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    next_mul_fu_249_p2 <= std_logic_vector(unsigned(phi_mul_reg_145) + unsigned(ap_const_lv15_708));
    tmp_5_fu_255_p2 <= std_logic_vector(unsigned(i4_cast3_reg_291) + unsigned(phi_mul_reg_145));
    tmp_6_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_5_fu_255_p2),64));
    tmp_7_cast_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_183_p3),6));
    tmp_8_cast_fu_216_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_211_p2),64));
    tmp_8_fu_211_p2 <= std_logic_vector(unsigned(tmp_7_cast_reg_278) + unsigned(tmp_cast_fu_207_p1));
    tmp_cast_fu_207_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_reg_111),6));
    tmp_fu_183_p3 <= (i_reg_100 & ap_const_lv1_0);
    training_data_V_address0 <= tmp_6_fu_260_p1(15 - 1 downto 0);
