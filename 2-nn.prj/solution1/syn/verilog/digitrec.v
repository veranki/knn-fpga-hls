...
(* CORE_GENERATION_INFO="digitrec,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.310750,HLS_SYN_LAT=993704,HLS_SYN_TPT=none,HLS_SYN_MEM=97,HLS_SYN_DSP=0,HLS_SYN_FF=322,HLS_SYN_LUT=763}" *)
...
reg   [5:0] tmp_7_cast_reg_278;
wire   [0:0] exitcond1_fu_171_p2;
wire   [1:0] k_1_fu_201_p2;
wire    ap_CS_fsm_state3;
wire   [14:0] i4_cast3_fu_221_p1;
reg   [14:0] i4_cast3_reg_291;
wire    ap_CS_fsm_state4;
wire   [10:0] i_2_fu_231_p2;
reg   [10:0] i_2_reg_299;
wire   [3:0] j_2_fu_243_p2;
reg   [3:0] j_2_reg_307;
wire    ap_CS_fsm_state5;
wire   [14:0] next_mul_fu_249_p2;
reg   [14:0] next_mul_reg_312;
wire   [0:0] exitcond_fu_237_p2;
reg   [47:0] training_instance_V_reg_322;
...
wire   [4:0] grp_knn_vote_fu_156_knn_set_V_address0;
...
wire   [4:0] grp_update_knn_fu_161_min_distances_V_address0;
...
wire   [4:0] grp_update_knn_fu_161_min_distances_V_address1;
...
wire   [63:0] tmp_6_fu_260_p1;
wire   [4:0] tmp_fu_183_p3;
wire   [5:0] tmp_cast_fu_207_p1;
wire   [5:0] tmp_8_fu_211_p2;
wire   [14:0] tmp_5_fu_255_p2;
reg   [7:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_fu_225_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_171_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i4_reg_122 <= 11'd0;
    end else if (((exitcond_fu_237_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        i4_reg_122 <= i_2_reg_299;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond3_fu_195_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((exitcond2_fu_225_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        j_reg_133 <= 4'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_171_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        k_reg_111 <= 2'd0;
    end else if (((exitcond3_fu_195_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i4_cast3_reg_291[10 : 0] <= i4_cast3_fu_221_p1[10 : 0];
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_171_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_7_cast_reg_278[4 : 1] <= tmp_7_cast_fu_191_p1[4 : 1];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        knn_set_V_address0 = tmp_8_cast_fu_216_p1;
...
always @ (*) begin
    if (((exitcond3_fu_195_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        knn_set_V_we0 = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((exitcond2_fu_225_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign exitcond2_fu_225_p2 = ((i4_reg_122 == 11'd1800) ? 1'b1 : 1'b0);

assign exitcond3_fu_195_p2 = ((k_reg_111 == 2'd2) ? 1'b1 : 1'b0);

assign exitcond_fu_237_p2 = ((j_reg_133 == 4'd10) ? 1'b1 : 1'b0);
...
assign i4_cast3_fu_221_p1 = i4_reg_122;

assign i_1_fu_177_p2 = (i_reg_100 + 4'd1);

assign i_2_fu_231_p2 = (i4_reg_122 + 11'd1);

assign j_2_fu_243_p2 = (j_reg_133 + 4'd1);

assign k_1_fu_201_p2 = (k_reg_111 + 2'd1);

assign next_mul_fu_249_p2 = (phi_mul_reg_145 + 15'd1800);

assign tmp_5_fu_255_p2 = (i4_cast3_reg_291 + phi_mul_reg_145);

assign tmp_6_fu_260_p1 = tmp_5_fu_255_p2;

assign tmp_7_cast_fu_191_p1 = tmp_fu_183_p3;

assign tmp_8_cast_fu_216_p1 = tmp_8_fu_211_p2;

assign tmp_8_fu_211_p2 = (tmp_7_cast_reg_278 + tmp_cast_fu_207_p1);

assign tmp_cast_fu_207_p1 = k_reg_111;

assign tmp_fu_183_p3 = {{i_reg_100}, {1'd0}};

assign training_data_V_address0 = tmp_6_fu_260_p1;

always @ (posedge ap_clk) begin
    tmp_7_cast_reg_278[0] <= 1'b0;
    tmp_7_cast_reg_278[5] <= 1'b0;
    i4_cast3_reg_291[14:11] <= 4'b0000;
end
