...
architecture behav of digitrec is 
    ...
    "digitrec,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.310750,HLS_SYN_LAT=1137764,HLS_SYN_TPT=none,HLS_SYN_MEM=97,HLS_SYN_DSP=0,HLS_SYN_FF=339,HLS_SYN_LUT=803}";
    ...
    signal i_2_reg_273 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_7_cast_fu_191_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_7_cast_reg_278 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond1_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_1_fu_201_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal i_3_fu_231_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_3_reg_299 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_fu_183_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_cast_fu_207_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_8_fu_211_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_171_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    tmp_7_cast_reg_278(5 downto 2) <= tmp_7_cast_fu_191_p1(5 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_7_cast_reg_278(1 downto 0) <= "00";
    tmp_7_cast_reg_278(6) <= '0';
    ...
    exitcond3_fu_195_p2 <= "1" when (k_reg_111 = ap_const_lv3_4) else "0";
    ...
    i_3_fu_231_p2 <= std_logic_vector(unsigned(i4_reg_122) + unsigned(ap_const_lv11_1));
    j_2_fu_243_p2 <= std_logic_vector(unsigned(j_reg_133) + unsigned(ap_const_lv4_1));
    k_1_fu_201_p2 <= std_logic_vector(unsigned(k_reg_111) + unsigned(ap_const_lv3_1));
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            knn_set_V_address0 <= tmp_8_cast_fu_216_p1(6 - 1 downto 0);
    ...
    tmp_7_cast_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_183_p3),7));
    ...
    tmp_cast_fu_207_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_reg_111),7));
    tmp_fu_183_p3 <= (i_reg_100 & ap_const_lv2_0);
