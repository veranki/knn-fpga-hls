...
digitrec::digitrec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, i_2_reg_273, "i_2_reg_273");
...
void digitrec::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        ...
        i_3_reg_299 = i_3_fu_231_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_2_reg_273 = i_2_fu_177_p2.read();
    }
...
void digitrec::thread_exitcond3_fu_195_p2() {
    exitcond3_fu_195_p2 = (!k_reg_111.read().is_01() || !ap_const_lv3_4.is_01())? sc_lv<1>(): sc_lv<1>(k_reg_111.read() == ap_const_lv3_4);
}
...
void digitrec::thread_i_3_fu_231_p2() {
    i_3_fu_231_p2 = (!i4_reg_122.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i4_reg_122.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void digitrec::thread_k_1_fu_201_p2() {
    k_1_fu_201_p2 = (!k_reg_111.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(k_reg_111.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void digitrec::thread_knn_set_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        knn_set_V_address0 =  (sc_lv<6>) (tmp_8_cast_fu_216_p1.read());
...
void digitrec::thread_tmp_7_cast_fu_191_p1() {
    tmp_7_cast_fu_191_p1 = esl_zext<7,6>(tmp_fu_183_p3.read());
}

void digitrec::thread_tmp_8_cast_fu_216_p1() {
    tmp_8_cast_fu_216_p1 = esl_zext<64,7>(tmp_8_fu_211_p2.read());
}

void digitrec::thread_tmp_8_fu_211_p2() {
    tmp_8_fu_211_p2 = (!tmp_7_cast_reg_278.read().is_01() || !tmp_cast_fu_207_p1.read().is_01())? sc_lv<7>(): (sc_biguint<7>(tmp_7_cast_reg_278.read()) + sc_biguint<7>(tmp_cast_fu_207_p1.read()));
}

void digitrec::thread_tmp_cast_fu_207_p1() {
    tmp_cast_fu_207_p1 = esl_zext<7,3>(k_reg_111.read());
}

void digitrec::thread_tmp_fu_183_p3() {
    tmp_fu_183_p3 = esl_concat<4,2>(i_reg_100.read(), ap_const_lv2_0);
}
