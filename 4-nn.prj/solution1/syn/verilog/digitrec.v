...
(* CORE_GENERATION_INFO="digitrec,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.310750,HLS_SYN_LAT=1137764,HLS_SYN_TPT=none,HLS_SYN_MEM=97,HLS_SYN_DSP=0,HLS_SYN_FF=339,HLS_SYN_LUT=803}" *)
...
wire   [6:0] tmp_7_cast_fu_191_p1;
reg   [6:0] tmp_7_cast_reg_278;
wire   [0:0] exitcond1_fu_171_p2;
wire   [2:0] k_1_fu_201_p2;
wire    ap_CS_fsm_state3;
wire   [14:0] i4_cast3_fu_221_p1;
reg   [14:0] i4_cast3_reg_291;
wire    ap_CS_fsm_state4;
wire   [10:0] i_3_fu_231_p2;
reg   [10:0] i_3_reg_299;
...
wire   [5:0] tmp_fu_183_p3;
wire   [6:0] tmp_cast_fu_207_p1;
wire   [6:0] tmp_8_fu_211_p2;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_171_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_7_cast_reg_278[5 : 2] <= tmp_7_cast_fu_191_p1[5 : 2];
    end
end
...
assign exitcond3_fu_195_p2 = ((k_reg_111 == 3'd4) ? 1'b1 : 1'b0);
...
assign i_3_fu_231_p2 = (i4_reg_122 + 11'd1);

assign j_2_fu_243_p2 = (j_reg_133 + 4'd1);

assign k_1_fu_201_p2 = (k_reg_111 + 3'd1);
...
assign tmp_fu_183_p3 = {{i_reg_100}, {2'd0}};

assign training_data_V_address0 = tmp_6_fu_260_p1;

always @ (posedge ap_clk) begin
    tmp_7_cast_reg_278[1:0] <= 2'b00;
    tmp_7_cast_reg_278[6] <= 1'b0;
